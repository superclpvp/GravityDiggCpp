...
LDFLAGS = $(addprefix -L,$(LIB_DIR)) -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lfreetype -lopengl32 -lwinmm -lgdi32 -lsfml-main -lbox2d

# Arquivos fonte e objetos 
SRCS = main.cpp codes/gameEngine.cpp 
OBJS = $(SRCS:.cpp=.o)
